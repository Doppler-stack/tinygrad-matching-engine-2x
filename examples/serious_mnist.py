...
# Add 'extra' folder to path explicitly
sys.path.insert(
    0, os.path.abspath(os.path.join(os.path.dirname(__file__), "..", "extra"))
)

print("PYTHONPATH:", sys.path)  # leave this in to confirm!
import numpy as np

from extra.augment.augment_img import augment_img
